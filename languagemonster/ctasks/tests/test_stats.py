...
def test_count_words_user_learned(mock_ds2wp, mock_userwordpair):
    ...
    mock_userwordpair.return_value.select_related.return_value = [
    ...
    mock_ds2wp.return_value.select_related.return_value = mo.LINKS_1
...
def test_compute_user_streak(mock_userresult):
    for test in streak_tests:
        mock_userresult.return_value.select_related.\
            return_value.order_by.return_value = test['ret']
